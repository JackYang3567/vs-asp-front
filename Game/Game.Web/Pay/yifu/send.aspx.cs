    ...
    public partial class send : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (tradeno.errorcode.ToInt(0) > 0)
            {
                ...
                {
                    string apiurl = ApplicationSettings.Get("url_yifu").ToStringOrEmpty();
                    ...
                    string returnUrl = ApplicationSettings.Get("url").ToStringOrEmpty() + "Pay/yifu/return_url.aspx";
                    string notifyUrl = ApplicationSettings.Get("url").ToStringOrEmpty() + "Pay/yifu/notify_url.aspx";
                    string remark = "1";
