        ...
        public partial class send : PageBase
        {
            ...
            protected void Page_Load(object sender, EventArgs e)
            {
                ...
                if (tradeno.errorcode.ToInt(0) > 0)
                {
                    ...
                    {
                        string apiurl = System.Configuration.ConfigurationManager.AppSettings["url_jr"].ToStringOrEmpty();
                        string partner = System.Configuration.ConfigurationManager.AppSettings["parter_jr"].ToStringOrEmpty();
                        string key = System.Configuration.ConfigurationManager.AppSettings["key_jr"].ToStringOrEmpty();
                        string ordernumber = tradeno1;
                        string banktype = Request["banktype"].ToStringOrEmpty();
                        string attach = "";
                        string paymoney = Request["money"].ToStringOrEmpty();
                        string callbackurl = System.Configuration.ConfigurationManager.AppSettings["url"].ToStringOrEmpty() + "Pay/JRPay/notify_url.aspx";
                        string hrefbackurl = System.Configuration.ConfigurationManager.AppSettings["url"].ToStringOrEmpty() + "Pay/JRPay/notify_url.aspx";
            ...
            private string AddOrder()
            {
                ...
                try
                {
                    ...
                    ret = dal.AddOrder(requestParams["userid"].ToInt(0), price, ip, priceType, 201);
                }
                catch (Exception ex)
                {
                    ret = ex.Message;
