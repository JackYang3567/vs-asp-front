<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send.aspx.cs" Inherits="Game.Web.Pay.zhifubank.send" %>
...
<body>
    <form action="https://pay.zhihpay.com/gateway?input_charset=UTF-8" id="dinpayForm" name="dinpayForm" method="POST" runat="server">
