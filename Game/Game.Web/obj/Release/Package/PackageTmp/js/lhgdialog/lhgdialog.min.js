...
(function (a, b, c) {
    var d = b.ActiveXObject && !b.XMLHttpRequest,
		...
		m, n = function (a, b, c) {
		    ...
		    return c = c.split("?"), m = c[1], c[0].substr(0, c[0].lastIndexOf("/") + 1)
		...
		q, r = function (a) {
		    try {
		        q = a.top.document, q.getElementsByTagName
		    } catch (b) {
		        return q = a.document, a
		    }
    ...
    })(q.getElementById("lhgdialoglink")), d &&
	function (a) {
    ...
    var v = function (a) {
        ...
        return a.id = a.id || k + f, b = v.list[a.id], b ? b.zindex().focus() : (a.button = a.button || [], a.ok && a.button.push({
            id: "ok",
            name: a.okVal,
            callback: a.ok,
            focus: a.focus
    ...
    v.fn = v.prototype = {
        ...
        button: function () {
            ...
            return d.style.display = g.length ? "" : "none", b._ie6SelectFix(), b
        },
        title: function (a) {
            if (a === c) return this;
            var b = this.DOM,
				d = b.border,
				e = b.title[0];
            return a === !1 ? (e.style.display = "none", e.innerHTML = "", d.addClass("ui_state_tips")) : (e.style.display = "", e.innerHTML = a, d.removeClass("ui_state_tips")), this
        },
        content: function (a, b, d) {
            ...
            var e = this,
				...
				m = f.content,
				n = v.setting.content;
            return d ? (m[0].innerHTML = n, e._iframe(a.split("url:")[1])) : m.html(a), b || (h = g.offsetWidth - h, i = g.offsetHeight - i, j -= h / 2, k -= i / 2, g.style.left = Math.max(j, 0) + "px", g.style.top = Math.max(k, 0) + "px", l && l !== "auto" && (g.style.width = g.offsetWidth + "px"), e._autoPositionType()), e._ie6SelectFix(), e
        },
        size: function (a, b) {
            var c = this,
				d = c.DOM,
				e = d.wrap[0],
				f = d.main[0].style;
            return e.style.width = "auto", typeof a == "number" && (a += "px"), typeof b == "number" && (b += "px"), f.width = a, f.height = b, a !== "auto" && (e.style.width = e.offsetWidth + "px"), c._ie6SelectFix(), c
        },
        position: function (a, b) {
            ...
            return a !== c && b !== c && e._autoPositionType(), e
        },
        time: function (a, b) {
            var c = this,
				d = c._timer;
            return d && clearTimeout(d), b && b.call(c), a && (c._timer = setTimeout(function () {
                c._click("cancel")
            }, 1e3 * a)), c
        },
        show: function (b) {
            return this.DOM.wrap[0].style.visibility = "visible", this.DOM.border.addClass("ui_state_visible"), !b && this._lock && (a("#ldg_lockmask", q)[0].style.display = ""), this
        },
        hide: function (b) {
            return this.DOM.wrap[0].style.visibility = "hidden", this.DOM.border.removeClass("ui_state_visible"), !b && this._lock && (a("#ldg_lockmask", q)[0].style.display = "none"), this
        },
        zindex: function () {
            var a = this,
				b = a.DOM,
				...
				d = v.focus,
				e = v.setting.zIndex++;
            return b.wrap[0].style.zIndex = e, d && d.DOM.border.removeClass("ui_state_focus"), v.focus = a, b.border.addClass("ui_state_focus"), c && c.style.zIndex && (c.style.display = "none"), d && d !== a && d.iframe && (d._load.style.display = ""), a
        },
        focus: function () {
            try {
        ...
        lock: function () {
            var b = this,
				...
				h = g ? g.style : "",
				i = d ? "absolute" : "fixed";
            return g || (c = '<iframe src="javascript:\'\'" style="width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1;filter:alpha(opacity=0)"></iframe>', g = q.createElement("div"), g.id = "ldg_lockmask", g.style.cssText = "position:" + i + ";left:0;top:0;width:100%;height:100%;overflow:hidden;", h = g.style, d && (g.innerHTML = c), q.body.appendChild(g)), i === "absolute" && (h.width = _$top.width(), h.height = _$top.height(), h.top = _$top.scrollTop(), h.left = _$top.scrollLeft(), b._setFixed(g)), h.zIndex = e, h.display = "", b.zindex(), b.DOM.border.addClass("ui_state_lock"), b._lock = !0, b
        },
        unlock: function () {
            var b = this,
				c = b.config,
        ...
        max: function () {
            ...
            return a._maxState ? (_$html.removeClass("ui_lock_scroll"), e.top = a._or.t, e.left = a._or.l, a.size(a._or.w, a._or.h)._autoPositionType(), i.drag = a._or.d, i.resize = a._or.r, g.cursor = a._or.rc, h.cursor = a._or.tc, c.res[0].style.display = "none", c.max[0].style.display = "inline-block", delete a._or, a._maxState = !1) : (_$html.addClass("ui_lock_scroll"), a._minState && a.min(), a._or = {
                ...
                rc: g.cursor,
                tc: h.cursor
            }, e.top = j + "px", e.left = k + "px", b = a._maxSize(), a.size(b.w, b.h)._setAbsolute(), d && t && (e.width = _$top.width() + "px"), i.drag = !1, i.resize = !1, g.cursor = "auto", h.cursor = "auto", c.max[0].style.display = "none", c.res[0].style.display = "inline-block", a._maxState = !0), a
        },
        min: function () {
            var a = this,
				b = a.DOM,
            ...
            return a._minState ? (c.display = "", d.display = a._minRz.btn, e.width = "", g = a._minRz, f.cursor = a._minRz.rzs ? "se-resize" : "auto", delete a._minRz, a._minState = !1) : (a._maxState && a.max(), a._minRz = {
                rzs: g,
                btn: d.display
            }, c.display = "none", d.display = "none", e.width = c.width, f.cursor = "auto", g = !1, a._minState = !0), a._ie6SelectFix(), a
        },
        get: function (a, b) {
        ...
        _getDOM: function () {
            ...
            return c.insertBefore(b, c.firstChild), f
        },
        ...
        _maxSize: function () {
            var a = this,
				...
				d = b.main[0],
				e, f;
            return e = _$top.width() - c.offsetWidth + d.offsetWidth, f = _$top.height() - c.offsetHeight + d.offsetHeight, {
                w: e,
                h: f
            }
        },
		...
		function () {
		    var a = this.DOM.wrap,
				...
				e = b.offsetWidth,
				f = b.offsetHeight;
		    e += "px", f += "px", d ? (d.style.width = e, d.style.height = f) : (d = b.appendChild(q.createElement("iframe")), a[c] = d, d.src = "javascript:''", d.style.cssText = "position:absolute;z-index:-1;left:0;top:0;filter:alpha(opacity=0);width:" + e + ";height:" + f)
		} : e,
        ...
        _reset: function () {
            ...
            if (c && Math.abs(j - newWidth) === 17) return;
            (k || l) && f.position(k, l)
        },
        _addEvent: function () {
            var a, b = this,
            ...
            b._winResize = function () {
                ...
                if (c === d.close[0]) return b._click("cancel"), !1;
                if (c === d.max[0] || c === d.res[0] || c === d.max_b[0] || c === d.res_b[0] || c === d.res_t[0]) return b.max(), !1;
                if (c === d.min[0] || c === d.min_b[0]) return b.min(), !1;
                e = c[k + "callback"], e && b._click(e)
            }).bind("mousedown", function (a) {
                b.zindex();
                var e = a.target;
                if (c.drag !== !1 && e === d.title[0] || c.resize !== !1 && e === d.rb[0]) return w(a), !1
        ...
        h && h.DOM.wrap.remove(), _$doc.unbind("keydown", i), a("#ldg_lockmask", q)[0] && a("#ldg_lockmask", q).remove(), a("#ldg_dragmask", q)[0] && a("#ldg_dragmask", q).remove()
    }), v.setting = {
    ...
    v.dragEvent = {
        ...
        start: function (a) {
            var b = v.dragEvent;
            return _$doc.bind("mousemove", b.move).bind("mouseup", b.end), b._sClientX = a.clientX, b._sClientY = a.clientY, b.onstart(a.clientX, a.clientY), !1
        },
        onmove: e,
        move: function (a) {
            var b = v.dragEvent;
            return b.onmove(a.clientX - b._sClientX, a.clientY - b._sClientY), !1
        },
        onend: e,
        end: function (a) {
            var b = v.dragEvent;
            return _$doc.unbind("mousemove", b.move).unbind("mouseup", b.end), b.onend(a.clientX, a.clientY), !1
        }
    }, w = function (b) {
