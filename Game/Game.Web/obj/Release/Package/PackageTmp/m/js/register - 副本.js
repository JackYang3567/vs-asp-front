...
$(function () {
    ...
    $('#btnReg').click(function () {
        ...
        var postData = { account: account, pwd: pwd, vcode: vcode, adid: adid, adname: adname };
        $.ajaxSetup({
            async: false
        });
        isChuli = true;
...
function download(){
	...
	if(getCookie("name")!= null){
		...
		document.writeln("            <a href=\'itms-services://?action=download-manifest&url=https://web.iwcx.cx/m/boshidun.plist\' id=\'ios_url\' class=\'fl ios-btn download\'>");
document.writeln("                <img src=\'images/yun_apple_btn.png\' alt=\'苹果下载\' />");
document.writeln("            </a>");
document.writeln("            <a href=\'boshidun.apk\' id=\'android_url\' class=\'fl android-btn download\'>");
